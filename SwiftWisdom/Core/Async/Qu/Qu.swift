...
public class Qu {
    ...
    public class func Background(_ block: Block) -> Self {
        let q = self.init(priority: .background)
        return q.Run(block)
    }
    
    public class func Main(_ block: Block) -> Self {
        let q = self.init(priority: .main)
        return q.Run(block)
    }
    
    public class func Custom(_ queue: OperationQueue, block: Block) -> Self {
    ...
    public func Run(_ block: Block) -> Self {
        return queue(block)
    }
    
    public func Also(_ block: Block) -> Self {
        return queue(block)
    }
    
    public func Then(_ block: Block) -> Self {
        return ThenAfter(.last, block: block)
    }
    
    public func ThenAfter(_ dependency: Dependency, block: Block) -> Self {
    ...
    public func Finally(_ block: Block) -> Self {
    ...
    public func FinallyOn(_ priority: Priority, block: Block) -> Self {
        let wrapped: Block = {
    ...
    private func queue(_ block: Block) -> Self {
...
func +=(operationQueue: OperationQueue, block: Block) {
...
private extension OperationQueue {
    ...
    func setCompletion(_ block: Block) -> Operation {
        let blockOp = Operation(block: block)
