...
public extension UIView {
    public static func pa_percentAnimate(_ duration: TimeInterval, animation: (AnimationState) -> Void) {
...
private final class Animation {
    ...
    private init(id: String, duration: TimeInterval, animation: (AnimationState) -> Void) {
        self.start = Date()
